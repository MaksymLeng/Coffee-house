        ...
        <>
            <header className="home">
                ...
                <div className='home__content'>
                    ...
                    <div className="home__decor"><Transition boolColor = {true}/></div>
                    <h2 className="home__subtitle text-md text-white text-preline">{t('home.subtitle')}</h2>
                    <button className="home__btn text-sm font-bold text-white"
                            onClick={goToMorePages}>{t('button.more')}</button>
                </div>
            </header>
            <section className="aboutUs">
                <div className="aboutUs__content">
                    <h2 className="aboutUs__title text-black text-md font-normal">{t('aboutUs.title')}</h2>
                    <div className="aboutUs__decor"><Transition boolColor = {false}/></div>
